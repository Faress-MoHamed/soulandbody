...
export default function VacationRequestPopUp() {
	...
	const validateForm = () => {
		let newErrors: any = {};
		if (!formData.employee) newErrors.employee = t("hrVacations.errors.employeeRequired");
		if (!formData.leaveType) newErrors.leaveType = t("hrVacations.errors.leaveTypeRequired");
		if (
			!formData.leaveDays ||
		...
		if (!formData.leaveStart) newErrors.leaveStart = t("hrVacations.errors.leaveStartRequired");
		if (!formData.leaveEnd) newErrors.leaveEnd = t("hrVacations.errors.leaveEndRequired");
		if (
			formData.leaveStart &&
			formData.leaveEnd &&
