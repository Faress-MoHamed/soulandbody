"use client";
import TaxOnInvoice from "@/app/dashboard/companies/SalesInvoices/components/TaxOnInvoice";
...
export default function ExchangeTopComponent({
	selectedInvoice,
	setSelectedInvoice,
}: {
	selectedInvoice?: any;
	...
	const t = useTranslations("exchangeTopComponent");
