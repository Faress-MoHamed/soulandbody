...
import { useWarehousesData, type WarehouseType } from "./hooks/usewarehouses";
...
export default function page() {
	...
	const productColumns: ColumnDef<InventoryProductsType>[] = [
		{ accessorKey: "productCode", header: t("inventory.products.productCode") },
		{ accessorKey: "productName", header: t("inventory.products.productName") },
		{ accessorKey: "category", header: t("inventory.products.category") },
		{ accessorKey: "unit", header: t("inventory.products.unit") },
		{ accessorKey: "date", header: t("inventory.classCard.date") },
		{
							...
							ButtonTrigger: () => {
								return (
									<CustomPopUp
										...
										DialogContentComponent={() => <AddNewWareHouse />}
									/>
								);
							},
							UserComponent: () => (
